...
COMPILER_COMMAND = \
	$(COMPILER) $(COMPILER_FLAGS) $(PREPROCESSOR_FLAGS) $(COMPILER_INCLUDE_DIRECTORIES) $(DEPENDENCY_FLAGS) \
	-c $< -o $@
...
ifeq ($(TARGET_OUTPUT_TYPE), static)
	...
	LINKER_COMMAND	  = \
		$(COMPILER) $(LINKER_FLAGS) $(LINKER_SHARED_FLAGS) $^ $(COMPILER_STATIC_LIBRARIES) -o $@
