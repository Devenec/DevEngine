...
Void* AllocationPolicy::allocate(const Uint size, const Char8* file, const Uint32 line, const Char8* function)
{
	DE_ASSERT(size > 0u);
...
void AllocationPolicy::deallocate(Void* pointer, const Uint size)
{
